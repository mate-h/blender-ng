...
def beamng_terrain_node_group(displacement_image=None, layermap_image=None, material=None, position=(0.0, 0.0, 0.0), size=1024.0, resolution=1024, height=100.0):
    ...
    set_position.location = (1217.6103515625, 64.8414535522461)
    ...
    math.location = (473.8108825683594, -29.46165657043457)
    ...
    vector_math.location = (857.4999389648438, -47.79850387573242)
    vector_math_001.location = (1037.5001220703125, -9.17709732055664)
    group_input_001.location = (616.7258911132812, -247.5055389404297)
    math_002.location = (849.0042724609375, -279.8308410644531)
    combine_xyz_001.location = (1104.187744140625, -323.0660705566406)
    ...
    group.links.new(grid.outputs[0], set_position.inputs[0])
